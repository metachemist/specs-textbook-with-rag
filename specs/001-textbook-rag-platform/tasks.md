...
- [ ] T001 Create web directory for Docusaurus frontend
- [ ] T002 Initialize Docusaurus project (TypeScript) in `/web`
- [ ] T003 [P] Install Tailwind CSS & PostCSS dependencies
- [ ] T004 [P] Configure `tailwind.config.js` and `docusaurus.config.ts`
- [ ] T005 [P] Clean up default "Hello World" blog posts and pages
- [ ] T006 Create the `/src/components` folder for future widgets
- [ ] T007 Create server directory for FastAPI backend
- [ ] T008 Initialize FastAPI project in `/server`
- [ ] T009 Create requirements.txt file in server directory with required dependencies
...
- [ ] T010 [P] Create docs directory structure in web/docs for all modules
- [ ] T011 Setup sidebars.js to match the specified syllabus structure
- [ ] T012 Create base component files for ChatBotWidget, PersonalizeButton, and TranslateButton
- [ ] T013 Setup basic API structure in server for chat and personalization endpoints
- [ ] T014 [P] Install and configure Better Auth for user authentication
- [ ] T015 Create database models for User and ChatLog entities
- [ ] T016 Set up environment configuration management for both web and server
...
- [ ] T019 [P] [US1] Generate `web/docs/01-introduction/01-physical-ai-foundations.md`
- [ ] T020 [P] [US1] Generate `web/docs/02-module-1-ros2/01-nodes-and-topics.md`
- [ ] T021 [P] [US1] Generate `web/docs/02-module-1-ros2/02-urdf-humanoids.md`
- [ ] T022 [P] [US1] Generate `web/docs/03-module-2-digital-twin/01-gazebo-physics.md`
- [ ] T023 [P] [US1] Generate `web/docs/03-module-2-digital-twin/02-unity-integration.md`
- [ ] T024 [P] [US1] Generate `web/docs/04-module-3-nvidia-isaac/01-isaac-sim-setup.md`
- [ ] T025 [P] [US1] Generate `web/docs/04-module-3-nvidia-isaac/02-nav2-path-planning.md`
- [ ] T026 [P] [US1] Generate `web/docs/05-module-4-vla/01-voice-to-action.md`
- [ ] T027 [P] [US1] Generate `web/docs/05-module-4-vla/02-llm-cognitive-planning.md`
- [ ] T028 [P] [US1] Generate `web/docs/06-capstone/01-autonomous-humanoid.md`
- [ ] T029 [US1] Update sidebar navigation to include all generated content
- [ ] T030 [US1] Implement responsive design with Tailwind CSS for all content pages
